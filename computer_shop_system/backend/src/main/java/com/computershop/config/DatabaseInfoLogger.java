 ...
 * Hữu ích để kiểm tra (debug) xem ứng dụng đang kết nối tới instance cơ sở dữ liệu nào.
 */
@Component
...
public class DatabaseInfoLogger {
    ...
    public void logDatabaseInfo() {
        try (Connection conn = dataSource.getConnection()) {
            ...
            // Thử lấy thông tin từ Environment nếu việc đọc metadata JDBC trực tiếp thất bại
