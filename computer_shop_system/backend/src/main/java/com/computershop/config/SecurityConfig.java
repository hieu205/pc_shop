 ...
 * Cấu hình bảo mật cho các endpoint REST API với kiểm soát truy cập theo vai trò (role-based).
 */
@Configuration
@EnableWebSecurity
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers("/api/v1/cart/**").hasAnyRole("CUSTOMER", "STAFF", "ADMIN")
                .requestMatchers("/api/v1/orders/**").hasAnyRole("CUSTOMER", "STAFF", "ADMIN")
                .requestMatchers(HttpMethod.POST, "/api/v1/products/*/comments").hasAnyRole("CUSTOMER", "STAFF", "ADMIN")
                .requestMatchers(HttpMethod.DELETE, "/api/v1/comments/**").hasAnyRole("CUSTOMER", "STAFF", "ADMIN")
