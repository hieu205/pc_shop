...
/**
 * DTO tổng hợp thông tin low-stock.
 * Dùng cho ADMIN/STAFF để nhanh chóng xem các sản phẩm cần chú ý.
 */
@Data
@Builder
@NoArgsConstructor
...
public class LowStockSummaryResponse {
    ...
    private Integer totalNeedRestock;
        ...
        /** Tạo summary từ danh sách Product */
    public static LowStockSummaryResponse fromProducts(
        ...
        /** Tạo summary từ danh sách InventoryResponse (DTO) — dùng khi service đã trả về DTO */
