...
public class JwtUtils {
    ...
    @Value("${app.jwt.secret:computershopsecretsigningkey2024veryverylongsecretkey}")
    ...
    /**
     * Extract user id claim (user_id) from token if present
     */
    ...
    /**
     * Lấy user id hiện tại từ SecurityContext nếu có JWT raw được lưu trong Authentication.details
     */
