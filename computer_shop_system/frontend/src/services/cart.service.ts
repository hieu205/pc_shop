...
export const cartService = {
  ...
  throw new Error('Lấy giỏ hàng thất bại - cấu trúc phản hồi không hợp lệ');
      ...
      const summary: CartSummary = {
        ...
        final_amount: cartData.final_amount || totalAmount,
      };
        ...
        try {
          ...
          if (body && (body.items || body.cart_items)) {
            ...
            const summary: CartSummary = {
              ...
              subtotal: (body.total_amount || 0),
              tax_amount: (body.tax_amount || 0),
              shipping_cost: (body.shipping_cost || 0),
              discount_amount: (body.discount_amount || 0),
              promotion: body.promotion || null,
              total_amount: (body.total_amount || 0) - (body.discount_amount || 0),
              final_amount: body.final_amount || ((body.total_amount || 0) - (body.discount_amount || 0)),
            };
